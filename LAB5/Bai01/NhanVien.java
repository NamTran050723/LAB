...
abstract class NhanVien {
    ...
    public NhanVien(String maNhanVien, String tenNhanVien, String trinhDo, String luongCoBan) {
    ...
    public void xuat(){
        System.out.println("\n Ma nhan vien: " + this.maNhanVien + ", Ten nhan vien: " + this.tenNhanVien + ", Trinh do: " + this.trinhDo + ", Luong co ban: " + this.luongCoBan);
    }
